...
//        $('iframe',tabContentEl).load(function(){
//        	//$(this).prev().remove();
//        });
      }
    },
  ...
  var navTabItem = Component.Controller.extend(
  {
    ...
    */
    ...
    ATTRS : 
    {
      ...
      tabContentTpl : {
        view : true,
        value : '<div class="' + CLS_CONTENT + '" style="position:relative;display:none;"><div class="fn-loading"></div><iframe src="" style="display:none;" width="100%" height="100%" frameborder="0"></iframe></div>'
      },
      /**
       * 标签页指定的URL
       * @cfg {String} href
