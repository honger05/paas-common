...
seajs.config({
    ...
    alias: {
        ...
        '$indexeddb': 'jquery/indexeddb/1.0.0/indexeddb',
        '$slimscroll': 'jquery/slimscroll/1.3.3/slimscroll',
        'underscore':'gallery/underscore/1.8.2/underscore',
        'handlebars': 'gallery/handlebars/1.0.2/handlebars',
        'highcharts': 'gallery/highcharts/2.3.5/highcharts',
        'bootstrap': 'gallery/bootstrap/3.0.0/bootstrap',
        'jslet-data': 'gallery/jslet/3.0.0/jslet-data',
        'jslet-ui': 'gallery/jslet/3.0.0/jslet-ui',
        'plupload': 'gallery/plupload/1.5.6/plupload',
        'queue': 'gallery/plupload/1.5.6/queue',
        'moment': 'gallery/moment/2.0.0/moment',
        'ckeditor': 'gallery/ckeditor/ckeditor',
        'emqttws': 'gallery/emqttd/1.0.0/mqttws',
        'xlsx': 'gallery/xlsx/1.3.2/xlsx',
        // 公用库样式配置
        'css-main': 'asset/common/1.0.0/main.css',
        'css-resetui': 'asset/common/1.0.0/resetui.css',
        'css-default': 'asset/theme/default-1.0.1/default.css',
        'css-black': 'asset/theme/black-1.0.1/black.css',
        'css-blue': 'asset/theme/blue-1.0.1/blue.css',
        'css-bui': 'gallery/bui4/css/bs3/bui.css',
    }
});

if(System.DEBUGMODEL){
	
	seajs.config({
		alias: {
	        'clui': 'cl-ued/dist/1.0.3/clui-debug',
	        'common': 'cl-commonjs/dist/1.1.3/common-debug',
	        'bizcommon': 'cl-commonjs/dist/1.1.3/bizcommon-debug',
	        'filter': 'cl-commonjs/dist/1.1.3/filter-debug'
		}
	});
	...
	seajs.config({
		alias: {
	        'clui': 'cl-ued/dist/1.0.3/clui',
	        'common': 'cl-commonjs/dist/1.1.3/common',
	        'bizcommon': 'cl-commonjs/dist/1.1.3/bizcommon',
	        'filter': 'cl-commonjs/dist/1.1.3/filter'
		}
	});
